...
entry:
  ...
  %t3 = getelementptr %Big, %Big* null, i32 1
  %t4 = ptrtoint %Big* %t3 to i64
  %t5 = load i64, i64* @frame.off
  %t6 = add i64 %t5, %t4
  %t7 = icmp ugt i64 %t6, 8192
...
; Global Constants
@.str.0 = private unnamed_addr constant [70 x i8] c"star runtime error: a `frame:` block exceeded its 8192-byte capacity\0A\00"
@.str.1 = private unnamed_addr constant { i64, i8*, [65 x i8] } { i64 -1, i8* null, [65 x i8] c"configured budget covered the same allocation the default cannot\00" }
