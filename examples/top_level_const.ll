...
entry:
  ...
  %t2 = getelementptr inbounds { i64, i8*, [21 x i8] }, { i64, i8*, [21 x i8] }* @.str.0, i64 0, i32 2, i64 0
  call void @star_rc_release(i8* %t2)
  %t3 = call i32 @board_width()
  %t4 = getelementptr inbounds [46 x i8], [46 x i8]* @.str.1, i64 0, i64 0
  call i32 (i8*, ...) @printf(i8* %t4, i8* %t2, i32 32, i32 24, i32 768, i32 %t3)
  %t5 = getelementptr inbounds [5 x i8], [5 x i8]* @.str.2, i64 0, i64 0
  %t6 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.3, i64 0, i64 0
  %t7 = select i1 false, i8* %t5, i8* %t6
  %t8 = getelementptr inbounds [52 x i8], [52 x i8]* @.str.4, i64 0, i64 0
  %t9 = fpext float 0x40139999A0000000 to double
  %t10 = fpext float 0x4040000000000000 to double
  call i32 (i8*, ...) @printf(i8* %t8, double %t9, double %t10, i8* %t7)
  ret i32 0
}


; Global Constants
@.str.0 = private unnamed_addr constant { i64, i8*, [21 x i8] } { i64 -1, i8* null, [21 x i8] c"top_level_const demo\00" }
@.str.1 = private unnamed_addr constant [46 x i8] c"%s: %dx%d grid, %d cells, board is %dpx wide\0A\00"
@.str.2 = private unnamed_addr constant [5 x i8] c"true\00"
@.str.3 = private unnamed_addr constant [6 x i8] c"false\00"
@.str.4 = private unnamed_addr constant [52 x i8] c"half gravity = %f, cols as float = %f, square = %s\0A\00"
