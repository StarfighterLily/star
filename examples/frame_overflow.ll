...
frame_alloc_ok_1:
  ...
  %t151 = getelementptr inbounds [65 x i8], [65 x i8]* @.str.1, i64 0, i64 0
  %t150 = alloca i8*
...
@.str.1 = private unnamed_addr constant [65 x i8] c"should not reach here: frame allocator did not abort on overflow\00"
