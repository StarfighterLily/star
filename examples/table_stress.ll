...
if_then_142:
  ...
  call void @star_rc_release(i8* %t699)
...
table_read_end_147:
  ...
  %t720 = getelementptr inbounds %Item, %Item* %t495, i32 0, i32 1
  %t721 = load i8*, i8** %t720
  call void @star_rc_release(i8* %t721)
  %t722 = getelementptr inbounds %Item, %Item* %t468, i32 0, i32 1
  %t723 = load i8*, i8** %t722
  call void @star_rc_release(i8* %t723)
  %t724 = getelementptr inbounds %Item, %Item* %t440, i32 0, i32 1
  %t725 = load i8*, i8** %t724
  call void @star_rc_release(i8* %t725)
  %t726 = getelementptr inbounds %Item, %Item* %t413, i32 0, i32 1
  %t727 = load i8*, i8** %t726
  call void @star_rc_release(i8* %t727)
  %t728 = load i8*, i8** %t249
  call void @star_rc_release(i8* %t728)
  %t729 = getelementptr inbounds %Item, %Item* %t245, i32 0, i32 1
  %t730 = load i8*, i8** %t729
  call void @star_rc_release(i8* %t730)
  %t731 = getelementptr inbounds %Item, %Item* %t218, i32 0, i32 1
  %t732 = load i8*, i8** %t731
  call void @star_rc_release(i8* %t732)
  %t733 = getelementptr inbounds %Item, %Item* %t191, i32 0, i32 1
  %t734 = load i8*, i8** %t733
  call void @star_rc_release(i8* %t734)
  %t735 = getelementptr inbounds %Item, %Item* %t164, i32 0, i32 1
